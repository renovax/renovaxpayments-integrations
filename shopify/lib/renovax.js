/**
 * RENOVAX Payments — minimal API client for the Shopify connector.
 * Mirrors the auth/error pattern of the WooCommerce and Dhru integrations.
 */
